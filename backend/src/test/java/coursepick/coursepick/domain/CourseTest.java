...
class CourseTest {
    ...
    void 코스의_난이도를_계산한다(List<Coordinate> coordinates, RoadType roadType, InclineSummary inclineSummary, Difficulty expectedDifficulty) {
        var course = new Course("코스", roadType, inclineSummary, coordinates);
