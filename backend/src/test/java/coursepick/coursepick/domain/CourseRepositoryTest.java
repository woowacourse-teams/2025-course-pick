...
class CourseRepositoryTest {
    ...
    void 거리를_줄여가면서_검색되는_코스_수가_줄어든다(int distance, int expectedSize) {
        Course course1 = new Course("잠실 한강 산책길", CourseType.원형, RoadType.알수없음, List.of(
        ...
        Course course2 = new Course("잠실 종합운동장", CourseType.원형, RoadType.알수없음, List.of(
        ...
        Course course3 = new Course("잠실제일교회 둘레길", CourseType.원형, RoadType.알수없음, List.of(
