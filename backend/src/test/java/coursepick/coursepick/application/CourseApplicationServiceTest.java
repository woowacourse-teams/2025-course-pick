...
import coursepick.coursepick.domain.CourseType;
...
class CourseApplicationServiceTest {
    ...
    @Test
    void 가까운_코스들을_조회한다() {
        Course course1 = new Course("한강 러닝 코스", CourseType.원형, RoadType.알수없음, List.of(
                new Coordinate(37.5180, 127.0280),
                new Coordinate(37.5175, 127.0270),
                new Coordinate(37.5170, 127.0265),
                new Coordinate(37.5180, 127.0280)
        ));
        Course course2 = new Course("양재천 산책길", CourseType.원형, RoadType.알수없음, List.of(
                new Coordinate(37.5165, 127.0285),
                new Coordinate(37.5160, 127.0278),
                new Coordinate(37.5155, 127.0265),
                new Coordinate(37.5165, 127.0285)
        ));
        Course course3 = new Course("북악산 둘레길", CourseType.원형, RoadType.알수없음, List.of(
