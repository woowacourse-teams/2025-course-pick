...
class CourseApplicationServiceTest extends IntegrationTest {
    ...
    void 코스는_최소_1KM부터_탐색할_수_있다() {
        Course course1 = new Course("한강 러닝 코스", RoadType.트랙, InclineSummary.UNKNOWN, List.of(
                new Coordinate(37.5180, 127.0280),
                new Coordinate(37.5175, 127.0270),
                new Coordinate(37.5170, 127.0265),
                new Coordinate(37.5180, 127.0280)
        ));
        Course course2 = new Course("양재천 산책길", RoadType.트랙, InclineSummary.UNKNOWN, List.of(
                new Coordinate(37.5165, 127.0285),
                new Coordinate(37.5160, 127.0278),
                new Coordinate(37.5155, 127.0265),
                new Coordinate(37.5165, 127.0285)
        ));
        Course course3 = new Course("북악산 둘레길", RoadType.트레일, InclineSummary.UNKNOWN, List.of(
    ...
    void 코스는_최대_3KM까지_탐색할_수_있다() {
        ...
        Course course2 = new Course("북악산 둘레길", RoadType.트레일, InclineSummary.UNKNOWN, List.of(
